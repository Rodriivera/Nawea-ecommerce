      ...
      <section className="edge min-h-[80vh] flex items-center justify-center py-20">
        <div className="w-full max-w-md">
          <ScrollReveal variant="slide-left" delay={100} duration={850}>
            <p className="label-xs text-accent">Acceso</p>
          </ScrollReveal>

          <ScrollReveal variant="fade-up" delay={250} duration={1000}>
            <h1 className="display-xl mt-3">Iniciar Sesión</h1>
            <p className="mt-2 text-sm text-muted-foreground">
              Ingresá a tu cuenta para gestionar tus pedidos y guardar tus piezas favoritas.
            </p>
          </ScrollReveal>
